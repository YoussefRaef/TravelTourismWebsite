  ...
  const markAsRead = async (notificationId) => {
    try {
      const response = await axios.patch(
        `http://localhost:4000/api/anotifications2/${notificationId}/aread2`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div style={{ padding: '20px', background: '#f7f7f7' }}>
      <button
        ...
        onClick={() => navigate('/seller-home')} // Navigate back to To-Do page
      >
        Back
      </button>
